(function ($) {
    ...
    -----------------------------------*/
    $.scrollUp({
        scrollText: '<i class="fa-solid fa-angles-up"></i>',
        easingType: 'linear',
        scrollSpeed: 1000,
        animation: 'fade'
    });   
    ...
    $('.shop_toolbar_btn > button').on('click', function (e) {
		...
		if(viewMode == 'grid_4'){
			parentsDiv.children().addClass('col-lg-3 col-md-4 col-sm-6').removeClass('col-12');
		}
        if(viewMode == 'grid_list'){
			parentsDiv.children().addClass('col-12').removeClass('col-lg-3 col-md-4 col-sm-6');
		}
